    ...
    Ctx: Context + 'static,
{
    fn new<C: ContextFactory<Ctx>>(
        ...
        for _ in 0..num_threads {
            ...
            let ctx = f.create();
            let mut tb = Builder::new().name(name.to_string());
...
mod test {
    ...
    fn test_get_task_count() {
        let name = "test_get_task_count".to_string();
    ...
    fn test_task_context() {
        ...
        let ctx = f.create();
        let name = "test_tasks_with_contexts".to_string();
    ...
    fn test_task_tick() {
        ...
        let ctx = f.create();
        let name = "test_tasks_tick".to_string();
