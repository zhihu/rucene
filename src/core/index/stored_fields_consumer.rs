...
use core::codec::{
    Codec, StoredFieldsFormat, StoredFieldsReader, StoredFieldsWriter, StoredFieldsWriterEnum,
};
use core::doc::FieldType;
use core::doc::STORE_FIELD_TYPE;
...
use core::index::{FieldInfo, Fieldable, SegmentWriteState, Status, StoredFieldVisitor};
use core::store::{Directory, IOContext, LockValidatingDirectoryWrapper, TrackingDirectoryWrapper};
...
pub(super) struct StoredFieldsConsumerImpl<
...
pub(super) type TrackingTmpDirectory<D> = TrackingTmpOutputDirectoryWrapper<
...
pub(super) struct SortingStoredFieldsConsumerImpl<
    D: Directory + Send + Sync + 'static,
    C: Codec,
    MS: MergeScheduler,
    MP: MergePolicy,
...
pub(super) enum StoredFieldsConsumer<
    D: Directory + Send + Sync + 'static,
    C: Codec,
    MS: MergeScheduler,
    MP: MergePolicy,
